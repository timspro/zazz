function trim(l){return l.replace(/^\s\s*/,"").replace(/\s\s*$/,"")}
function doStuff(){$(document).ready(function(){function l(a,b,c){$("#-zazz-modal-confirm .-zazz-modal-header")[0].innerHTML=a;$("#-zazz-modal-confirm .-zazz-modal-body")[0].innerHTML=b;$("#-zazz-modal-confirm .-zazz-modal-button")[0].onclick=c;$("#-zazz-modal-confirm").center().show()}function h(a,b,c){"undefined"===typeof c&&(c="");$("#-zazz-modal-alert .-zazz-modal-body").html(b);$("#-zazz-modal-alert .-zazz-modal-header").html(a);$("#-zazz-modal-alert").attr("style",c).center().show()}function p(){"undefined"!==
typeof $.last_div&&$.last_div.css("box-shadow","");var a=$(".-zazz-content").attr("data-zazz-rid",$.row_id).attr("data-zazz-gid",$.group_id).attr("data-zazz-eid",$.element_id)[0].outerHTML;$.post("/zazz/ajax/layout.php",{page_id:$("#-zazz-page-id").val(),layout:a});"undefined"!==typeof $.last_div&&v($.last_div)}function q(a,b,c,d,e){"undefined"===typeof e&&(e=!1);b={zazz_id:a,type:c,code:b.val(),page_id:$("#-zazz-page-id").val(),zazz_order:b.attr("data-zazz-order"),insert:d};e?b["delete"]=!0:b.insert=
d;$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/code.php",b,function(b){$("#-zazz-loader-bar").demote();"begin-project"===a||"end-project"===a||"begin-web-page"===a||"end-web-page"===a?("html"===c&&location.reload(),$(".-zazz-content").first().html(b)):($('.-zazz-element[data-zazz-id="'+a+'"]').html(b),$(".-zazz-code-block-"+a).filter(".-zazz-js-code").each(function(){w($(this).val())}))})}function x(a){var b;a.hasClass("-zazz-html-code")?b="html":a.hasClass("-zazz-css-code")?b="css":a.hasClass("-zazz-mysql-code")?
...
""):h.css("right","0").css("left","");a.pageY>m+k/2?h.css("top",m).css("bottom",""):h.css("bottom",n-(m+k)).css("top","");$("#-zazz-modal-mouse-offset").html("<td>Offset (px):</td><td>("+d+",</td><td>"+c+",</td><td>"+($(a.target).outerHeight()-d)+",</td><td>"+(b.outerWidth()-c)+")</td>");$("#-zazz-modal-mouse-location").html("<td>Page (px):</td><td>("+(a.pageY-m)+",</td><td>"+a.pageX+",</td><td>"+(l-(a.pageY-m))+",</td><td>"+(f-a.pageX)+")</td>");$("#-zazz-modal-mouse-offsetp").html("<td>Offset (%):</td><td>("+
Math.round(d/e*1E4)/100+",</td><td>"+Math.round(c/g*1E4)/100+",</td><td>"+Math.round((e-d)/e*1E4)/100+",</td><td>"+Math.round((g-c)/g*1E4)/100+")</td>");$("#-zazz-modal-mouse-locationp").html("<td>Page (%):</td><td>("+Math.round((a.pageY-m)/l*1E4)/100+",</td><td>"+Math.round(a.pageX/f*1E4)/100+",</td><td>"+Math.round((l-(a.pageY-m))/l*1E4)/100+",</td><td>"+Math.round((f-a.pageX)/f*1E4)/100+")</td>")});$(".-zazz-code-blocks").on("focus",".-zazz-html-code, .-zazz-php-code, .-zazz-mysql-code, .-zazz-js-code",
...
typeof $.last_div&&$.last_div.attr("id",$(this).val())});$(".-zazz-class-input").blur(function(){"undefined"!==typeof $.last_div&&$.last_div.attr("class",$(this).val()+" -zazz-element -zazz-outline")});$(".-zazz-select-btn").register(function(){},function(){},function(){});$(".-zazz-vertical-btn").register(function(){$(".-zazz-content-view").on("mousemove",F);$(".-zazz-content-view").on("mouseenter",G);$(".-zazz-content-view").on("mouseleave",u);$("#-zazz-fixed").css("display","inline-block");$("#-zazz-fixed-vertical").show()},
function(a,b){var c=0<parseInt(a.css("z-index"))?!0:!1,d=$("#-zazz-fixed-vertical").val();if(c&&"Both"!==d)h("Warning","You cannot have a child element that has a dynamic width for a fixed width element.");else if(c||"Both"!==d){var e=a.outerWidth(),g=b.pageX-a.offset().left,n=e-g,e=k("element-"+$.element_id,"-zazz-element");$.element_id++;if(c)a.css("width",g),e.css("width",n).css("z-index","1"),e.insertAfter(a);else{var f;if("Left"===d||"Right"===d)a.parent().hasClass("-zazz-container")?f=a.parent():
(f=$("<div></div>").addClass("-zazz-container").css("width",a.outerWidth()/a.parent().outerWidth()*100+"%"),a.css("width",""),f.insertAfter(a),f.append(a));"Left"===d?(f.css("padding-left",parseInt(f.css("padding-left"))+g).css("margin-left",parseInt(f.css("margin-left"))-g),e.css("width",g).css("z-index","1"),e.insertBefore(f)):"Right"===d?(f.css("padding-right",parseInt(f.css("padding-right"))+n).css("margin-right",parseInt(f.css("margin-right"))-n),e.css("width",n).css("z-index","1"),e.insertAfter(f)):
"None"===d&&(f=a.parent(),c=f.outerWidth()-parseInt(f.css("padding-left"))-parseInt(f.css("padding-right")),g=g/c*100,c=a.outerWidth()/c*100,a.css("width",g+"%"),e.css("width",c-g+"%"),e.insertAfter(a))}e.css("min-height",a.css("min-height"));a.focus();p()}else h("Warning","You cannot have both children elements have fixed width for a dynamic width element.")},function(){u();$(".-zazz-content-view").off("mouseenter",G);$(".-zazz-content-view").off("mouseleave",u);$(".-zazz-content-view").off("mousemove",
F);$("#-zazz-fixed").hide();$("#-zazz-fixed-vertical").hide()});$(".-zazz-across-btn").register(function(){$(".-zazz-content-view").on("mousemove",D);$(".-zazz-content-view").on("mouseenter",E);$(".-zazz-content-view").on("mouseleave",t)},function(a,b){var c,d,e;c=a.parent();1===c.children().length&&c.hasClass("-zazz-row")?(c.parent(),d=c):(c=k("row-group-"+$.group_id,"-zazz-row-group"),c.css("width",r(a)),a.css("width",""),c.insertAfter(a),d=k("row-"+$.row_id,"-zazz-row"),$.group_id++,$.row_id++,
c.append(d),d.append(a));e=k("row-"+$.row_id,"-zazz-row");c=k("element-"+$.element_id,"-zazz-element");e.append(c);$.row_id++;$.element_id++;e.insertAfter(d);e=a.outerHeight();d=a.offset().top;e-=b.pageY-d;a.css("min-height",b.pageY-d);c.css("min-height",e);"auto"!==a.css("z-index")&&c.css("z-index",a.css("z-index"));a.focus();p()},function(){t();$(".-zazz-content-view").off("mousemove",D);$(".-zazz-content-view").off("mouseenter",E);$(".-zazz-content-view").off("mouseleave",t)});$(".-zazz-absorb-btn").register(function(){},
function(a,b,c){if("undefined"===typeof this.first_div||c)this.first_div=a;else if(a[0]!==this.first_div[0]){b=$(a);a=$(this.first_div);var d=b.parent();c=a.parent();var e=d.parent(),g=c.parent();c.hasClass("-zazz-container")&&d.hasClass("-zazz-container")||c.hasClass("-zazz-row")&&d.hasClass("-zazz-row")&&d.get(0)===c.get(0)?(c=r(a),d=r(b),b.remove(),a.css("width",parseFloat(c)+parseFloat(d)+"%")):c.hasClass("-zazz-container")&&d.hasClass("-zazz-row")&&d.get(0)===g.get(0)?(d=b.outerWidth(),e=b.index(),
b.remove(),1===g.children().length?(c.children().each(function(){g.append($(this))}),c.remove()):e<c.index()?(c.css("margin-left",parseInt(c.css("margin-left"))+d),c.css("padding-left",parseInt(c.css("padding-left"))-d)):(c.css("margin-right",parseInt(c.css("margin-right"))+d),c.css("padding-right",parseInt(c.css("padding-right"))-d))):d.hasClass("-zazz-container")&&c.hasClass("-zazz-row")&&c.get(0)===e.get(0)?h("Error","You cannot absorb a dynamic width element into a fixed width element."):e.get(0)===
g.get(0)?1!==d.children().length||1!==c.children().length?h("Error","Both rows must only have one element before you can combine them."):(a.css("min-height",parseInt(b.css("min-height"))+parseInt(a.css("min-height"))),b.parent().remove(),b=a.parent().parent(),1!==b.children().length||b.parent().hasClass("-zazz-content")||(a.css("width",r(b)),a.insertBefore(b),b.remove())):h("Error","These elements are neither in the same row or column.");a.focus();delete this.first_div;p()}},function(){$(".-zazz-element").css("cursor",
"")});$("#-zazz-edit-page-btn").click(function(){$("#-zazz-modal-settings").show().center()});$(".-zazz-project-btn").click(function(){var a=$(this).offset();$("#-zazz-dropdown-project").show().css("top",a.top+$(this).outerHeight()).css("left",a.left)}).blur(function(){setTimeout(function(){"-zazz-edit-project-btn"===document.activeElement.id?$("#-zazz-modal-project").show().center():"-zazz-new-project-btn"===document.activeElement.id?$("#-zazz-modal-new-project").show().center():"-zazz-switch-project-btn"===
document.activeElement.id?$("#-zazz-modal-view-projects").show().center():"-zazz-delete-project-btn"===document.activeElement.id&&(1<$("#-zazz-modal-view-pages .-zazz-links a").length?l("Are you sure?","By deleting this project, you will remove all code and pages.",function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/project.php",{page_id:$("#-zazz-page-id").val(),deleted:"true"},function(){window.location.href="/zazz/index.php"})}):h("Warning","You cannot delete your only project."));$("#-zazz-dropdown-project").hide()},
1)});$("#-zazz-make-new-project").click(function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/project.php",{create:$("#-zazz-new-project-name").val()},function(a){$("#-zazz-loader-bar").demote();""!==trim(a)?$("#-zazz-modal-new-project .-zazz-modal-message").html(a):window.location.href="/zazz/build/"+$("#-zazz-new-project-name").val()+"/"})});$(".-zazz-page-btn").click(function(){var a=$(this).offset();$("#-zazz-dropdown-page").show().css("top",a.top+$(this).outerHeight()).css("left",a.left)}).blur(function(){setTimeout(function(){"-zazz-edit-page-btn"===
document.activeElement.id?$("#-zazz-modal-settings").show().center():"-zazz-new-page-btn"===document.activeElement.id?$("#-zazz-modal-new-page").show().center():"-zazz-switch-page-btn"===document.activeElement.id?$("#-zazz-modal-view-pages").show().center():"-zazz-delete-page-btn"===document.activeElement.id&&(1<$("#-zazz-modal-view-pages .-zazz-links a").length?l("Are you sure?","By deleting this page, you will remove all code.",function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/page.php",
...
window.location.href="/zazz/build/"+$("#-zazz-project-name").val()+"/"+$("#-zazz-new-page-name").val()})});$("#-zazz-deploy-project-btn").click(function(){$("#-zazz-modal-deploy-confirm").center().show()});$("#-zazz-upload-filename").focus(function(){$("#-zazz-upload-file").click();$(this).blur()});$("#-zazz-upload-file").change(function(){var a=$(this).val();$("#-zazz-upload-filename").val(a);var b=a.lastIndexOf("/");if(0>b&&(b=a.lastIndexOf("\\"),0>b)){$("#-zazz-upload-filename").val(a);return}a=
a.slice(b-a.length+1);$("#-zazz-upload-server").val(a)});$(".-zazz-upload-btn").click(function(){$("#-zazz-modal-upload").center().show()});$("#-zazz-upload-do-it").click(function(){$("#-zazz-upload-name").val($("#-zazz-upload-server").val());$("#-zazz-upload-page-id").val($("#-zazz-page-id").val());$("#-zazz-upload-form").submit()});$(".-zazz-html-btn").click(function(){s("html")});$(".-zazz-php-btn").click(function(){s("php")});$(".-zazz-mysql-btn").click(function(){s("mysql")});$(".-zazz-js-btn").click(function(){s("js")});
(function(){var a=$(".-zazz-content");$(".-zazz-element").first().focus();$(".-zazz-select-btn").click();$.row_id=a.attr("data-zazz-rid");$.group_id=a.attr("data-zazz-gid");$.element_id=a.attr("data-zazz-eid");$(".-zazz-css-code").each(function(){var a=$(this);A(y(a),a.val())});$(".-zazz-js-code").each(function(){var a=$(this);w(a.val())});$("#-zazz-page-height").val($(".-zazz-content").outerHeight()).attr("data-zazz-old-height",$(".-zazz-content").outerHeight());jQueryScriptOutputted&&h("Error",
"Could not find jQuery file specified in HTML header. Loaded a copy from Zazz instead.")})();$(document).keyup(function(a){if(13===a.which||13===a.keyCode){var b=$(".-zazz-modal:visible");if(0!==b.length){var b=b.first(),c=b.children(".-zazz-modal-footer").children(".-zazz-modal-button");0!==c.length?c.first().click():b.children(".-zazz-modal-footer").children(".-zazz-modal-close").first().click()}else{var d=$(":focus");d.is("textarea")?setTimeout(function(){var a=d.prop("selectionStart"),b=d.val(),
c=b.substr(0,a),a=b.substr(a,b.length),b=c.split("\n"),b=b[b.length-2].match(/^\s*/)[0];d.val(c+b+a);d[0].setSelectionRange(c.length+b.length,c.length+b.length)},1):d.click()}}if(27===a.keyCode||27===a.which)b=$(".-zazz-modal:visible"),0!==b.length&&b.children(".-zazz-modal-footer").children(".-zazz-modal-close").first().click(),$(".-zazz-select-btn").click();120!==a.keyCode&&120!==a.which||!a.ctrlKey||$(".-zazz-select-btn").focus();121!==a.keyCode&&121!==a.which||!a.ctrlKey||$.last_div.focus();122!==
a.keyCode&&122!==a.which||!a.ctrlKey||$(".-zazz-id-input").focus();if((123===a.keyCode||123===a.which)&&a.ctrlKey){a=$(".-zazz-code-blocks");for(b=a.children(":visible");0!==b.length;)a=b.first(),b=a.children(":visible");a.focus()}});$("#-zazz-bad-html").val()&&h("Error","There was an error when Zazz tried to combine the HTML entered for begin-project, end-project, begin-web-page, end-web-page, which forced Zazz to use a default HTML frame instead. Please examine the HTML for those elements so that your HTML frame can be loaded.")})}
