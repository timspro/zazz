...
"Right"===d?(f.css("padding-right",parseInt(f.css("padding-right"))+n).css("margin-right",parseInt(f.css("margin-right"))-n),e.css("width",n).css("z-index","1"),e.insertAfter(f)):"None"===d&&(f=a.parent(),c=f.outerWidth()-parseInt(f.css("padding-left"))-parseInt(f.css("padding-right")),g=g/c*100,c=a.outerWidth()/c*100,a.css("width",g+"%"),e.css("width",c-g+"%"),e.insertAfter(a))}e.css("min-height",a.css("min-height"));a.focus();p()}else h("Warning","You cannot have both children elements have fixed width for a dynamic width element.")},
...
$.group_id,"-zazz-row-group"),c.css("width",r(a)),a.css("width",""),c.insertAfter(a),d=k("row-"+$.row_id,"-zazz-row"),$.group_id++,$.row_id++,c.append(d),d.append(a));e=k("row-"+$.row_id,"-zazz-row");c=k("element-"+$.element_id,"-zazz-element");e.append(c);$.row_id++;$.element_id++;e.insertAfter(d);e=a.outerHeight();d=a.offset().top;e-=b.pageY-d;a.css("min-height",b.pageY-d);c.css("min-height",e);"auto"!==a.css("z-index")&&c.css("z-index",a.css("z-index"));a.focus();p()},function(){t();$(".-zazz-content-view").off("mousemove",
D);$(".-zazz-content-view").off("mouseenter",E);$(".-zazz-content-view").off("mouseleave",t)});$(".-zazz-absorb-btn").register(function(){},function(a,b,c){if("undefined"===typeof this.first_div||c)this.first_div=a;else if(a[0]!==this.first_div[0]){b=$(a);a=$(this.first_div);var d=b.parent();c=a.parent();var e=d.parent(),g=c.parent();c.hasClass("-zazz-container")&&d.hasClass("-zazz-container")||c.hasClass("-zazz-row")&&d.hasClass("-zazz-row")&&d.get(0)===c.get(0)?(c=r(a),d=r(b),b.remove(),a.css("width",
parseFloat(c)+parseFloat(d)+"%")):c.hasClass("-zazz-container")&&d.hasClass("-zazz-row")&&d.get(0)===g.get(0)?(d=b.outerWidth(),e=b.index(),b.remove(),1===g.children().length?(c.children().each(function(){g.append($(this))}),c.remove()):e<c.index()?(c.css("margin-left",parseInt(c.css("margin-left"))+d),c.css("padding-left",parseInt(c.css("padding-left"))-d)):(c.css("margin-right",parseInt(c.css("margin-right"))+d),c.css("padding-right",parseInt(c.css("padding-right"))-d))):d.hasClass("-zazz-container")&&
c.hasClass("-zazz-row")&&c.get(0)===e.get(0)?h("Error","You cannot absorb a dynamic width element into a fixed width element."):e.get(0)===g.get(0)?1!==d.children().length||1!==c.children().length?h("Error","Both rows must only have one element before you can combine them."):(a.css("min-height",parseInt(b.css("min-height"))+parseInt(a.css("min-height"))),b.parent().remove(),b=a.parent().parent(),1!==b.children().length||b.parent().hasClass("-zazz-content")||(a.css("width",r(b)),a.insertBefore(b),
b.remove())):h("Error","These elements are neither in the same row or column.");a.focus();delete this.first_div;p()}},function(){$(".-zazz-element").css("cursor","")});$("#-zazz-edit-page-btn").click(function(){$("#-zazz-modal-settings").show().center()});$(".-zazz-project-btn").click(function(){var a=$(this).offset();$("#-zazz-dropdown-project").show().css("top",a.top+$(this).outerHeight()).css("left",a.left)}).blur(function(){setTimeout(function(){"-zazz-edit-project-btn"===document.activeElement.id?
$("#-zazz-modal-project").show().center():"-zazz-new-project-btn"===document.activeElement.id?$("#-zazz-modal-new-project").show().center():"-zazz-switch-project-btn"===document.activeElement.id?$("#-zazz-modal-view-projects").show().center():"-zazz-delete-project-btn"===document.activeElement.id&&(1<$("#-zazz-modal-view-pages .-zazz-links a").length?l("Are you sure?","By deleting this project, you will remove all code and pages.",function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/project.php",
{page_id:$("#-zazz-page-id").val(),deleted:"true"},function(){window.location.href="/zazz/index.php"})}):h("Warning","You cannot delete your only project."));$("#-zazz-dropdown-project").hide()},1)});$("#-zazz-make-new-project").click(function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/project.php",{create:$("#-zazz-new-project-name").val()},function(a){$("#-zazz-loader-bar").demote();""!==trim(a)?$("#-zazz-modal-new-project .-zazz-modal-message").html(a):window.location.href="/zazz/build/"+
$("#-zazz-new-project-name").val()+"/"})});$(".-zazz-page-btn").click(function(){var a=$(this).offset();$("#-zazz-dropdown-page").show().css("top",a.top+$(this).outerHeight()).css("left",a.left)}).blur(function(){setTimeout(function(){"-zazz-edit-page-btn"===document.activeElement.id?$("#-zazz-modal-settings").show().center():"-zazz-new-page-btn"===document.activeElement.id?$("#-zazz-modal-new-page").show().center():"-zazz-switch-page-btn"===document.activeElement.id?$("#-zazz-modal-view-pages").show().center():
"-zazz-delete-page-btn"===document.activeElement.id&&(1<$("#-zazz-modal-view-pages .-zazz-links a").length?l("Are you sure?","By deleting this page, you will remove all code.",function(){$("#-zazz-loader-bar").promote();$.post("/zazz/ajax/page.php",{page_id:$("#-zazz-page-id").val(),deleted:"true"},function(){window.location.href="/zazz/index.php"})}):h("Warning","You cannot delete your only page."));$("#-zazz-dropdown-page").hide()},1)});$("#-zazz-make-new-page").click(function(){$("#-zazz-loader-bar").promote();
